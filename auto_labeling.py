...
class AutoLabeler:
    ...
    def calcBBox(self, img, criteria, imgCount):
        ...
        # TODO: need to tune for stable functionality
        imgObject = np.where(img < criteria)
        ...
        imgObjectBBox = cv2.rectangle(
            img, (BBoxXMin_px, BBoxYMin_px), (BBoxXMax_px, BBoxYMax_px), 100, 5)
    ...
    def saveBBoxImage(self, img, imgCount):
        BBoximageFileFullPath = self.BBoxImagesDirPath + \
    ...
    def saveLabel(self, classNumber, BBoxData, labelCount):
        ...
        labelFileFullPath = self.labelsDirPath + \
            "/" + str(labelCount).zfill(12) + ".txt"
        strBBoxData = ""
